...
var css = ".styles_chart__1caao {\n  margin-bottom: 1rem;\n}\n\n.styles_calendar__3Apt_ {\n  max-width: 100%;\n  height: auto;\n  margin-bottom: 0.25rem;\n  overflow: visible;\n}\n\n.styles_loading__3UiB4 {\n  font-size: 90%;\n}\n\n.styles_title__6Ggf1 {\n  margin-bottom: 0.5rem;\n  padding-bottom: 0.25rem;\n}\n";
var styles = {"chart":"styles_chart__1caao","calendar":"styles_calendar__3Apt_","loading":"styles_loading__3UiB4","title":"styles_title__6Ggf1"};
styleInject(css);
...
const NAMESPACE = 'react-github-heatmap';
...
function getGitHubGraphData(options) {
  const {
    fullYear,
    years,
    data
...
const Heatmap = ({
  ...
  const fetchData = useCallback(() => {
    setError(null);
    setGraphs(getGitHubGraphData({
      data,
      years,
      fullYear
    }));
  }, [years, data, fullYear]); // Fetch data on mount
...
export { Heatmap, createCalendarTheme };
